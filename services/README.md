...
| Service | Imported from | Import commit |
| --- | --- | --- |
| `bookbuddy-web` | `skyhaven-ltd/app-bookbuddy-web` | `7b67ce00b3f59e729ad967edf820cc2b412b9645` |
| `knowledge-mcp` | Developed in this repository | Not applicable |
| `stockalert-monitor` | `skyhaven-ltd/app-stockalert-monitor` | `f54ba2e7f2bd7a5ad13c914067b802975677e97f` |
